...
本目录是一份可在本机预览的静态中文教程。页面按课程顺序包含第零章人物参考图制作教程和第一章 Bobby × VIGOR 商品短片案例；保留原有两条案例视频、照片对照、五步流程和素材证据边界。页面尚未部署成网站。本目录未附开放素材再利用许可；公开仓库展示授权仅限当前课程页面。
...
- `index.html`、`styles.css`、`script.js`：页面与轻量交互。
